...
{
    if(mask.empty()) {
        return  ret.getName()+" = _mm_div_ps( "+a.getName()+" , "+b.getName()+" );" ;
    }
    else {
        return  ret.getName()+" = _mm_mask_div_ps( " + ret.getName() + "," + mask + "," +a.getName()+" , "+b.getName()+" );" ;
    }
}
...
{
    if(mask.empty()) {
        return  ret.getName()+" = _mm_sqrt_ps( "+a.getName()+" );" ;
    }
    else {
        return  ret.getName()+" = _mm_mask_sqrt_ps( " + ret.getName() + "," + mask + "," +a.getName()+" );" ;
    }
}
